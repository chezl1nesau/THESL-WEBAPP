            ...
            <div style={{ maxWidth: '800px', margin: '0 auto', width: '100%', paddingBottom: '3rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '2rem', background: 'rgba(255,255,255,0.03)', padding: '0.4rem', borderRadius: '12px', width: 'fit-content' }}>
                    <button 
                        ...
                        style={{ 
                            background: activeTab !== 'profile' ? 'transparent' : undefined, 
                            color: activeTab !== 'profile' ? 'var(--text-secondary)' : '#050b16',
                            border: 'none',
                    ...
                    <button 
                        ...
                        style={{ 
                            background: activeTab !== 'security' ? 'transparent' : undefined, 
                            color: activeTab !== 'security' ? 'var(--text-secondary)' : '#050b16',
                            border: 'none',
                            padding: '0.6rem 1.5rem'
                        }}
                ...
                {activeTab === 'profile' ? (
                    <div className="card glass-effect animate-page">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                            <h3 className="card-title">Personal Information</h3>
                            <button className="btn btn-outline" style={{ fontSize: '0.75rem', borderColor: 'var(--border)' }} onClick={() => setPassword('')}>Reset Fields</button>
                        </div>
                            ...
                            <div style={{ display: 'flex', gap: '2.5rem', flexWrap: 'wrap' }}>
                                <div style={{ flex: '0 0 150px' }}>
                                    ...
                                    >
                                        ...
                                        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'rgba(0,0,0,0.7)', color: 'white', fontSize: '0.65rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.1em', textAlign: 'center', padding: '0.6rem', backdropFilter: 'blur(8px)' }}>
                                            Change Photo
                                        </div>
                                    </div>
                                ...
                                <div style={{ flex: '1', minWidth: '300px' }}>
                                    ...
                                    <button type="submit" className="btn btn-primary" style={{ marginTop: '1.5rem', width: '100%', justifyContent: 'center', height: '48px' }}>
                    ...
                    <div className="card glass-effect animate-page">
                        ...
                        <div className="card" style={{ marginBottom: '1.5rem', border: '1px solid var(--border)', background: 'rgba(255,255,255,0.01)' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <div>
                                    <h4 style={{ margin: 0, color: 'white', fontSize: '1rem' }}>Two-Factor Authentication</h4>
                                    <p style={{ fontSize: '0.875rem', color: 'var(--text-light)', margin: '0.5rem 0 0', maxWidth: '400px' }}>
                                        Add an extra layer of security to your account using an authenticator app like Google Authenticator or 1Password.
                                    </p>
                                </div>
                                <div style={{ textAlign: 'right' }}>
                                    {tfaEnabled ? (
                                        <span className="badge badge-success" style={{ padding: '0.6rem 1.2rem', borderRadius: '10px' }}>PROTECTED</span>
                                    ) : (
                                        <span className="badge badge-warning" style={{ padding: '0.6rem 1.2rem', borderRadius: '10px' }}>UNSECURED</span>
                                    )}
                                </div>
                            </div>

                            {!tfaEnabled && !isSettingUp && (
                                <button className="btn btn-primary" style={{ marginTop: '1.5rem', height: '44px' }} onClick={handleSetup2FA}>
                                    Activate 2FA Protection 🛡️
                                </button>
                            )}
                                    ...
                                    <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap', alignItems: 'center' }}>
                                        ...
                                        <div style={{ flex: 1, minWidth: '250px' }}>
                                            ...
                                            <p style={{ fontSize: '0.875rem', color: 'var(--text-light)', marginBottom: '1rem' }}>
                                                ...
                                                <br />
                                                Manual secret: <strong style={{ color: 'var(--accent)' }}>{secret}</strong>
                                            </p>
